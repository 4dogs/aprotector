...
/*
 * ÎÒÃÇÐèÒªÎ´×°ÏäµÄÔ­Ê¼ÀàÐÍ×÷ÎªÒ»Ð©·´ÉäÔ­ÁÏ
 *
 * ÑéÖ¤DalvikÐéÄâ»úÖÐ´æÔÚÏàÓ¦µÄ×°ÏäÀà£¬²¢ÇÒÕâÐ©×°ÏäÀàÓÐÇÒ½öÓÐÒ»¸ö³ÉÔ±±äÁ¿£¬Õâ¸ö³ÉÔ±±äÁ¿ÊÇÓÃÀ´ÃèÊö¶ÔÓ¦µÄÊý×ÖÖµµÄ¡£
 * ÕâÐ©×°ÏäÀà°üÀ¨java.lang.Boolean¡¢java.lang.Character¡¢java.lang.Float¡¢java.lang.Double¡¢java.lang.Byte¡¢java.lang.Short¡¢java.lang.IntegerºÍjava.lang.Long¡£
 *
 * ËùÎ½×°Ïä£¬¾ÍÊÇ¿ÉÒÔ×Ô¶¯½«Ò»¸öÊýÖµ×ª»»Ò»¸ö¶ÔÏó£¬ÀýÈç£¬½«Êý×Ö1×Ô¶¯×ª»»ÎªÒ»¸öjava.lang.Integer¶ÔÏó¡£
 * ÏàÓ¦µØ£¬Ò²ÒªÇóÄÜ½«Ò»¸ö×°ÏäÀà¶ÔÏó×ª»»³ÉÒ»¸öÊý×Ö£¬ÀýÈç£¬½«Ò»¸öÖµµÈÓÚ1µÄjava.lang.Integer¶ÔÏó×ª»»ÎªÊý×Ö1
 */
bool dvmValidateBoxClasses()
{
    ...
    for (ccp = classes; *ccp != NULL; ccp++) {
		...
		/* Ê¹ÓÃÖ¸¶¨Àà¼ÓÔØÆ÷À´²éÕÒ¸ø³öÃèÊöÃû³ÆµÄÀà */
 ...
 */
/*
 * ´Ó'field' ´´½¨Ò»¸öÐÂµÄ java.lang.reflect.Field¶ÔÏó
 */
 ...
 */
/*
 * Í¨¹ýÒ»¸öÀà»ñÈ¡ËüÈ«²¿×Ö¶ÎÉùÃ÷£¬Õâ°üÀ¨¾²Ì¬ºÍÊµÀý×Ö¶Î
 */
 ...
 */
/*
 * Ê¹ÓÃ'meth'ÄÚÈÝÈ¥´´½¨Ò»¸öÐÂµÄ java/lang/reflect/Constructor¶ÔÏó£¬
 */
 ...
 */
/*
 * ´´½¨Ò»¸öÐÂµÄ java/lang/reflect/Method¶ÔÏó,Ê¹ÓÃ'meth'ÄÚÈÝÈ¥¹¹ÔìËü.
 *  
 */
 ...
 */
/*
 * »ñÈ¡Ò»¸ö×°Ïä»ù±¾Êý¾ÝÀàÐÍ £¬ÀýÈç java/lang/Integer
 */
 ...
 */
/*
 * ×ª»»»ù±¾Êý¾Ý£¬×°ÏäÊý¾Ý´Ó'srcPtr'µ½'dstPtr' eg.
 *  byte to short, int, long, float, double
 *  short to int, long, float double
 *  char to int, long, float, double
 *  int to long, float, double
 ...
 */
¡/*
 * ´´½¨Ò»¸ö»ù±¾Êý¾ÝÀàÐÍ×°ÏäºóµÄ¶ÔÏó£¬Èç¹û·µ»ØÀàÐÍ²»ÊÇ»ù±¾Êý¾ÝÀàÐÍ£¬ÄÇÃ´½ö½ö×ª»»'value'µ½Ò»¸ö¶ÔÏó²¢ÇÒ·µ»ØËü
 */
 ...
 */
/*
 * ÔÚÇ©ÃûÖÐÕÒµ½·µ»ØÀàÐÍ£¬²¢ÇÒ×ª»»Ëü³ÉÒ»¸ö¶ÔÏó.
 * ¶ÔÓÚ»ù±¾ÀàÐÍ£¬ÎÒÃÇÈ¥Ê¹ÓÃÒ»¸ö×°ÏäÀà£¬¶ÔÓÚÒýÓÃÀàÐÍ£¬ÎÒÃÇÈ¥×öÃû×Ö²éÑ¯
 */
 ...
 */
/*
 * ´´½¨Ò»¸ö java.lang.reflect.Field¶ÔÏó£¬·µ»ØÖµÍ¬ÑùÊÇÒ»¸öjava.lang.reflect.Field
 */
