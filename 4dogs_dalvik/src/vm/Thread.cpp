...
static Thread* allocThread(int interpStackSize)
{
    ...
    /* Check sizes and alignment 检查大小和对齐*/
    ...
    */
    ...
    // 两种类型的table，具体用哪个由InterpBreak中的breakFlag的值来确定
    // 这两个首地址在对应的汇编文件里面都能找到
    // 他们的定义类似如下:
    ...
    thread->interpBreak.ctl.curHandlerTable = thread->mainHandlerTable;//默认的表
#endif
